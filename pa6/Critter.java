...
//
// This class defines the methods necessary for an animal to be part of
//  the simulation.
// Your critter animal classes 'extend' this class to add to its basic
//  functionality.
//
...
public abstract class Critter {
  // The following five methods are the ones you must implement
  //  for your assignment.
  ...
  // I use these fields to implement the methods below such as
  //  getX and getNeighbor.
  private int x;
  private int y;
  private int width;
  private int height;
  ...
  // Sets the neighbor of this animal in the given direction to be the
  // given value, so that future calls to getNeighbor in that direction
  ...
  // sleeping, etc.
  // You can override these methods in your Husky to be informed of these
  // events.
