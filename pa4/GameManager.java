...
public class GameManager
{
    ...
    public void play() throws IOException
    {
        ...
        while (!this.board.isGameOver() && !quit) {
            ...
            String input = userInput.next(); // Asks for player input for each loop
            ...
            System.out.println(this.board.toString()); // Print board after a move
        }
